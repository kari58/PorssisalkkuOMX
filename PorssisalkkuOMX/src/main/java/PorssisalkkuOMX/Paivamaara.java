...
public class Paivamaara {
    ...
    /**
     * vanhinosake metodissa tarvitsee olla public int compareTo(Tapahtumat o) {
     * return
     * this.ostopaiva.palautakokolukuna()-o.ostopaiva.palautakokolukuna();
     * public double myy(String osake,int saldo){ // vanhinosake()
     * Collections.sort(super.osakkeet); FIFO säännön mukaan ensin pitää myydä,
     * jos osakkeitta on ostettu useampana aikakaidella:vanhin osake
     *
     * @return
     */
